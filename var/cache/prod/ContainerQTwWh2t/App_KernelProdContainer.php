...
class App_KernelProdContainer extends Container
{
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $b->setCacheFactory(new \Doctrine\ORM\Cache\DefaultCacheFactory($c, ($container->privates['doctrine.second_level_cache_pool'] ?? self::getDoctrine_SecondLevelCachePoolService($container))));
        $b->setRegionsConfiguration($c);
        $d = new \Doctrine\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')], true), 'App\\Entity');
        ...
        $a->setMetadataDriverImpl(new \Doctrine\Bundle\DoctrineBundle\Mapping\MappingDriver($d, new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    /*
     * Gets the private 'doctrine.second_level_cache_pool' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\AdapterInterface
     */
    protected static function getDoctrine_SecondLevelCachePoolService($container)
    {
        return $container->privates['doctrine.second_level_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LUrI8y0K1c', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C4UUi4f-j4', 3600, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getSecurity_Access_DecisionManagerService($container)
    {
        return $container->privates['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['App\\Security\\AbonnementVoter'] ??= new \App\Security\AbonnementVoter());
            yield 4 => ($container->privates['App\\Security\\InscriptionVoter'] ??= new \App\Security\InscriptionVoter());
